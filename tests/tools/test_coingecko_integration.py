...
from src.roma_glm.tools.crypto.coingecko import CoinGeckoToolkit
...
class TestCoinGeckoToolkitIntegration:
    ...
    def test_imports_work(self):
        ...
        from src.roma_glm.tools import CoinGeckoToolkit
        from src.roma_glm.tools.crypto import CoinGeckoToolkit as CoinGeckoToolkit2
        from src.roma_glm.tools.crypto.coingecko import CoinGeckoToolkit as CoinGeckoToolkit3
    ...
    def test_coingecko_endpoints_defined(self):
        ...
        from src.roma_glm.tools.crypto.coingecko.types import CoinGeckoEndpoint
