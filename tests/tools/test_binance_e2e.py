...
from src.roma_glm.tools.crypto.binance import BinanceToolkit
from src.roma_glm.tools.value_objects.crypto import (
    TrendDirection,
    VolatilityLevel,
    OrderSide,
)
...
class TestBinanceE2E:
    ...
    def test_type_safety_decimal_usage(self):
        ...
        from src.roma_glm.tools.value_objects.crypto import Kline, Trade
    ...
    def test_float_conversion_for_stats_is_intentional(self):
        ...
        from src.roma_glm.tools.utils.statistics import StatisticalAnalyzer
    ...
    def test_no_duplicate_enums_between_base_and_binance(self):
        ...
        from src.roma_glm.tools.crypto.binance.types import (
            BinanceMarketType,
            BinanceEndpoint,
        )
    ...
    def test_statistical_analysis_uses_base_enums(self):
        ...
        from src.roma_glm.tools.utils.statistics import StatisticalAnalyzer
        from src.roma_glm.tools.value_objects.crypto import TrendDirection, VolatilityLevel
        ...
        assert type(trend).__module__ == "src.roma_glm.tools.value_objects.crypto.trading"
        assert type(volatility).__module__ == "src.roma_glm.tools.value_objects.crypto.trading"
    ...
    def test_value_objects_have_computed_properties(self):
        ...
        from src.roma_glm.tools.value_objects.crypto import Kline, OrderBookSnapshot, OrderBookLevel
    ...
    def test_architecture_separation_of_concerns(self):
        ...
        from src.roma_glm.tools.utils.http_client import AsyncHTTPClient
        from src.roma_glm.tools.crypto.binance.client import BinanceAPIClient
        from src.roma_glm.tools.crypto.binance.toolkit import BinanceToolkit
    ...
    def test_multi_market_support(self):
        ...
        from src.roma_glm.tools.crypto.binance.types import BinanceMarketType, MARKET_CONFIGS
...
class TestCompleteness:
    ...
    def test_all_binance_endpoints_covered(self):
        ...
        from src.roma_glm.tools.crypto.binance.types import BinanceEndpoint
    ...
    def test_imports_all_work(self):
        ...
        # Utils
        from src.roma_glm.tools.utils import StatisticalAnalyzer
