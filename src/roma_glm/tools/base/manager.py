...
from roma_glm.tools.metrics.decorators import track_toolkit_lifecycle
...
class ToolkitManager:
    ...
    # Built-in toolkits
    BUILTIN_TOOLKITS = {
        "FileToolkit": "roma_glm.tools.core.file",
        "CalculatorToolkit": "roma_glm.tools.core.calculator",
        ...
        "ArkhamToolkit": "roma_glm.tools.crypto.arkham.toolkit",
        "MCPToolkit": "roma_glm.tools.mcp.toolkit",
    }
    ...
    async def _track_toolkit_event(
        ...
        from roma_glm.tools.metrics.models import ToolkitLifecycleEvent
