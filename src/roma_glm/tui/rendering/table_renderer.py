...
from roma_glm.tui.models import AgentGroupViewModel, ExecutionViewModel, TaskViewModel, TraceViewModel
from roma_glm.tui.rendering.formatters import Formatters
from roma_glm.tui.utils.helpers import ErrorCollector, Filters, ToolExtractor
...
class TableRenderer:
    ...
    def _get_tool_calls_for_mode(
        ...
        """
        from roma_glm.tui.utils.helpers import wrap_tool_calls_with_trace
    ...
    def render_error_table(
        ...
        """
        from roma_glm.tui.models import ExecutionViewModel, TaskViewModel
