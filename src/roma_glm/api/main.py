...
from roma_glm.api.execution_service import ExecutionService
from roma_glm.api.middleware import RequestLoggingMiddleware, RateLimitMiddleware
from roma_glm.api.dependencies import init_dependencies
...
def create_app(enable_rate_limit: bool = True) -> FastAPI:
    ...
    # Register routers
    from roma_glm.api.routers import (
        health,
        executions,
        checkpoints,
        metrics,
